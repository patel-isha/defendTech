    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <p class="info__text">
              110-114 Middlesex St, London E1 7HT
            </p>
          </div>
          <!-- end info-box -->
        </div>
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <p class="info__text">info@defendtech.com</p>
          </div>
          <!-- end info-box -->
        </div>
        <!-- end col-lg-3 -->
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <p class="info__text">+ 1 (888) 760 1940</p>
          </div>
          <!-- end info-box -->
        </div>
        <!-- end col-lg-3 -->
          ...
          <div class="card card-item">
            <div class="card-body">
              <form method="post" class="contact-form">
                ...
                <!-- end input-box -->
                <div class="btn-box">
                  <button id="send-message-btn" class="btn theme-btn" type="submit">
                    Send Message
                  </button>
                </div>
                <!-- end btn-box -->
      ...
      <div class="row pt-30px">
        <div class="col-lg-12">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2482.747551541622!2d-0.08046172418856379!3d51.5178473099412!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761cb3a11fde55%3A0x9e5f734778f9e989!2sNorthumbria%20University%20-%20London!5e0!3m2!1sen!2suk!4v1719267684313!5m2!1sen!2suk" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
