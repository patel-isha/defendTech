        ...
        <div class="col-lg-8 mb-5">
          <div class="card card-item">
            <div class="card-body">
              <p class="card-text pb-3">
                ...
                ii legunt saepius claritas Investig ationes. Pharetra dui, nec
                tincidunt ante mauris eu diam. Phasellus viverra nisl vitae
                cursus aei uismod suspendisse saepius claritas investig. Lorem
                ipsum dolor sit amet, consectet adipiscing elit, sed do
              ...
              <p class="card-text pb-3">
                ...
                massa fermentum sed. Duis ac maximus nulla, et pharetra
                turpis.
              </p>
              <div class="row pb-3">
                <div class="col-lg-6">
                  <h3 class="fs-20 font-weight-semi-bold">Content</h3>
                  <ul class="generic-list-item generic-list-item-bullet pt-3">
                ...
                <div class="col-lg-6">
                  <div class="mt-3">
                    <img src="assets/images/img-loading.png" data-src="assets/images/img1.jpg" alt="blog-img" class="img-fluid rounded-rounded lazy" />
                  </div>
                </div>
                <!-- end col-lg-6 -->
              </div>
              ...
              <p class="card-text pb-3">
                ...
                non cupidatat skateboard dolor brunch. Lorem ipsum dolor sit
                amet, consectetur adipisicing elit. Accusantium asperiores
              </p>
              <div class="section-block"></div>
              <h3 class="fs-18 font-weight-semi-bold pt-3">Tags</h3>
              <div class="d-flex flex-wrap justify-content-between align-items-center pt-3">
                <ul class="generic-list-item generic-list-item-boxed d-flex flex-wrap fs-15">
                  <li class="me-2"><a href="#">Web Design</a></li>
                  <li class="me-2"><a href="#">UI Design</a></li>
                </ul>
          ...
          <div class="instructor-wrap py-5">
            ...
            <div class="media media-card">
              <div class="media-img rounded-full avatar-lg me-4">
                <img src="assets/images/img-loading.png" data-src="assets/images/small-avatar-1.jpg" alt="Avatar image" class="rounded-full lazy" />
              </div>
          ...
          <div class="comments-wrap pt-5" id="comments">
              ...
              <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                ...
                <div class="media-body">
                  ...
                  <div class="helpful-action d-flex align-items-center justify-content-between">
                    <a class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30" href="#" data-bs-toggle="modal" data-bs-target="#replyModal"><i class="la la-reply me-1"></i> Reply</a>
                    <div class="ps-2">
            ...
            <div class="load-more-btn-box text-center pt-3 pb-5">
              <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30">
              ...
              <div class="card-body">
                ...
                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                  <a href="course-details.php" class="media-img">
                    <img class="me-3" src="assets/images/small-img-2.jpg" alt="Related course image" />
                  </a>
                  <div class="media-body">
                    <h5 class="fs-15">
                ...
                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                  <a href="course-details.php" class="media-img">
                    <img class="me-3" src="assets/images/small-img-3.jpg" alt="Related course image" />
                  </a>
                  <div class="media-body">
                    <h5 class="fs-15">
                ...
                <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                  <a href="course-details.php" class="media-img">
                    <img class="me-3" src="assets/images/small-img-4.jpg" alt="Related course image" />
                  </a>
                  <div class="media-body">
                    <h5 class="fs-15">
                ...
                <div class="view-all-course-btn-box">
                  <a href="blog-no-sidebar.php" class="btn theme-btn w-100">View All Posts <i class="la la-arrow-right icon ms-1"></i></a>
                </div>
              </div>
            </div>
            <!-- end card -->
            <div class="card card-item">
              <div class="card-body">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    <textarea class="form-control form--control ps-3" name="message" rows="4" placeholder="Write message"></textarea>
                  </div>
                  <div class="btn-box">
              ...
              <div class="card-body">
                ...
                <form method="post">
                  <div class="input-group">
                    <input class="form-control form--control ps-3" type="email" name="email" placeholder="Enter email address" />
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <div class="pe-2">
            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="replyModalLongTitle">
              Reply to comment
            </h5>
          </div>
          ...
          <form method="post">
            ...
            <div class="btn-box text-end">
              ...
              <button class="btn theme-btn theme-btn-sm" type="submit">
                Reply <i class="la la-arrow-right icon ms-1"></i>
              </button>
            </div>
            <!-- end btn-box -->
          </form>
