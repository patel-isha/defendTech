        ...
        <div class="container">
          <div class="hero-content">
            <div class="section-heading">
              <h2 class="section__title text-white fs-50 lh-70 pb-3">
                Empower Your Digital Security, <br />
                Stay Informed, Stay Safe
              </h2>
              <p class="section__desc text-white pb-4">
                Access essential tips and knowledge to protect yourself online <br /> and stay secure in the digital world.
              </p>
            </div>
            <!-- end section-heading -->
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1">
              <a href="register.php" class="btn theme-btn me-4 mb-4">Learn with Us <i class="la la-arrow-right icon ms-1"></i></a>
              </a>
            </div>
            <!-- end hero-btn-box -->
          </div>
        ...
        <div class="container">
          <div class="hero-content text-center">
            <div class="section-heading">
              ...
              <p class="section__desc text-white pb-4">
                Gain the knowledge and tools to secure your online presence, <br /> defend against threats, and thrive in a safe digital environment
              </p>
            </div>
            <!-- end section-heading -->
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-center">
              <a href="register.php" class="btn theme-btn me-4 mb-4">Get Started <i class="la la-arrow-right icon ms-1"></i></a>
        ...
        <div class="container">
          <div class="hero-content text-end">
            <div class="section-heading">
              ...
              <p class="section__desc text-white pb-4">
                Equip yourself with essential cybersecurity insights <br /> to protect your digital life effectively.
              </p>
            </div>
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-end">
              <a href="register.php" class="btn theme-btn mb-4"><i class="la la-arrow-left icon me-1"></i>Get Enrolled
              </a>
            </div>
            <!-- end hero-btn-box -->
          </div>
      ...
      <div class="row feature-content-wrap">
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            ...
            <div class="icon-element mx-auto shadow-sm">
              <img src="assets/images/icons/download.svg" width="60">
            </div>
            <h3 class="info__title">Interactive Learning Tools</h3>
            <p class="info__text">
              Use interactive simulations and quizzes to practice cybersecurity skills and apply knowledge in real-world scenarios.
            </p>
          </div>
          <!-- end info-box -->
        </div>
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            <div class="info-overlay"></div>
            <div class="icon-element mx-auto shadow-sm">
              <img src="assets/images/icons/resources.svg" width="70">
            </div>
            <h3 class="info__title">Comprehensive Educational Resources</h3>
            <p class="info__text">
              Access blogs, quizzes, and tutorials to understand cybersecurity risks and best practices.
            </p>
          </div>
          <!-- end info-box -->
        </div>
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="info-box">
            <div class="info-overlay"></div>
            <div class="icon-element mx-auto shadow-sm">
              <img src="assets/images/icons/user.svg" width="70">
            </div>
            <h3 class="info__title">User Experience Insights</h3>
            <p class="info__text">
              Provide feedback through surveys and interviews to improve our understanding of user knowledge and attitudes.
            </p>
          </div>
          <!-- end info-box -->
        </div>
      ...
      <div class="category-wrapper mt-30px">
        <div class="row">
          ...
          while ($row = $result->fetch_assoc()) {
            if (isset($row['cc_id'])) {
              $cc_id = $row['cc_id'];  // Get the category ID for the current row
              # Prepare the COUNT Query for courses in the current category
              $sqlCourseCount = "SELECT COUNT(course_id) as course_count FROM `course` WHERE cc_id='$cc_id'";
              $courseCountResult = $conn->query($sqlCourseCount);

              if ($courseCountResult) {
                $courseCountRow = $courseCountResult->fetch_assoc();
                $courseCount = $courseCountRow['course_count'];
              } else {
                $courseCount = 0;  // Default to 0 if query fails
              }
          ?>
              <div class="col-lg-4 responsive-column-half">
  ...
  <section class="course-area pb-120px">
    <div class="container">
      ...
      <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="business-tab" data-bs-toggle="tab" href="#business" role="tab" aria-controls="business" aria-selected="true">Business</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" id="drawing-tab" data-bs-toggle="tab" href="#drawing" role="tab" aria-controls="drawing" aria-selected="false">Drawing</a>
        </li>
        <li class="nav-item">
              ...
              <div class="col-lg-4 responsive-column-half">
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="card-title">
                      <a href="course-details.php">Ultimate Adobe Photoshop Training: From Beginner to
                        Pro</a>
                    </h5>
                    <p class="card-text">
                      <a href="teacher-detail.html">Jose Portilla</a>
              ...
              <div class="col-lg-4 responsive-column-half">
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_4">
                  ...
                  <div class="card-body">
                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Beginner</h6>
                    <h5 class="card-title">
                      <a href="course-details.php">The Ultimate Drawing Course - Beginner to Advanced</a>
                    </h5>
                    <p class="card-text">
                      <a href="teacher-detail.html">Jose Portilla</a>
                    </p>
  ...
  <section class="testimonial-area section-padding">
    <div class="container">
      <div class="section-heading text-center">
        ...
        <h2 class="section__title">Client's Feedback</h2>
        <span class="section-divider"></span>
      </div>
      <!-- end section-heading -->
    </div>
      ...
      <div class="testimonial-carousel owl-action-styled">
        <div class="card card-item">
          <div class="card-body">
            ...
            <!-- end media -->
            <p class="card-text">
              My children and I LOVE DefendTech! The courses are fantastic and the
        ...
        <div class="card card-item">
          <div class="card-body">
            ...
            <!-- end media -->
            <p class="card-text">
              Thank you DefendTech! You've renewed my passion for learning and my
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="about-content pb-5">
            ...
            <!-- end row -->
            <div class="btn-box">
              <a href="about.php" class="btn theme-btn">Learn More <i class="la la-arrow-right icon ms-1"></i></a>
            </div>
            <!-- end btn-box -->
          </div>
          <!-- end about-content -->
        ...
        <div class="col-lg-5 ms-auto">
          <div class="generic-img-box">
            <img src="assets/images/img-loading.png" data-src="assets/images/img13.jpg" alt="About image" class="img__item img__item-1 lazy" />
            <img src="assets/images/img-loading.png" data-src="assets/images/img14.jpg" alt="About image" class="img__item img__item-2 lazy" />
          </div>
          <!-- end generic-img-box -->
        </div>
        <!-- end col-lg-5 -->
    ...
    <div class="container">
      ...
      <div class="blog-post-carousel owl-action-styled half-shape mt-30px">
        <div class="card card-item">
          ...
          <div class="card-body">
            <h5 class="card-title">
              <a href="blog-detail.php">Sales Training: Practical Techniques</a>
            </h5>
            ...
            <div class="d-flex justify-content-between align-items-center pt-3">
              <a href="blog-detail.php" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="la la-arrow-right icon ms-1"></i></a>
        ...
        <div class="card card-item">
          ...
          <div class="card-body">
            <h5 class="card-title">
              <a href="blog-detail.php">Ultimate Photoshop Training: From Beginner</a>
            </h5>
            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
              <li class="d-flex align-items-center">
                By<a href="#">TechyDevs</a>
        ...
        <div class="card card-item">
          <div class="card-image">
            <a href="blog-detail.php" class="d-block">
              <img class="card-img-top" src="assets/images/img10.jpg" alt="Card image cap" />
            </a>
            <div class="course-badge-labels">
              <div class="course-badge">Jan 24, 2020</div>
            </div>
        ...
        <div class="card card-item">
          <div class="card-image">
            <a href="blog-detail.php" class="d-block">
              <img class="card-img-top" src="assets/images/img11.jpg" alt="Card image cap" />
            </a>
            <div class="course-badge-labels">
              <div class="course-badge">Jan 24, 2020</div>
            </div>
        ...
        <div class="card card-item">
          <div class="card-image">
            <a href="blog-detail.php" class="d-block">
              <img class="card-img-top" src="assets/images/img12.jpg" alt="Card image cap" />
            </a>
            <div class="course-badge-labels">
              <div class="course-badge">Jan 24, 2020</div>
            </div>
        ...
        <div class="card card-item">
          <div class="card-image">
            <a href="blog-detail.php" class="d-block">
              <img class="card-img-top" src="assets/images/img13.jpg" alt="Card image cap" />
            </a>
            <div class="course-badge-labels">
              <div class="course-badge">Jan 24, 2020</div>
            </div>
    ...
    <div id="tooltip_content_2">
      <div class="card card-item">
        <div class="card-body">
          ...
          <h5 class="card-title pb-1">
            <a href="course-details.php">Ultimate Adobe Photoshop Training: From Beginner to Pro</a>
          </h5>
          <div class="d-flex align-items-center pb-1">
            <h6 class="ribbon fs-14 me-2">Bestseller</h6>
            <p class="text-success fs-14 font-weight-medium">
    ...
    <div id="tooltip_content_5">
      <div class="card card-item">
        <div class="card-body">
          ...
          <h5 class="card-title pb-1">
            <a href="course-details.php">The Complete Digital Marketing Course - 12 Courses in 1</a>
          </h5>
          <div class="d-flex align-items-center pb-1">
            <h6 class="ribbon fs-14 me-2">Bestseller</h6>
            <p class="text-success fs-14 font-weight-medium">
