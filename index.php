        ...
        if ($result) {
          ...
          if ($result->num_rows > 0) {
            while ($category = $result->fetch_assoc()) {
              ...
              echo '<a class="nav-link ' . $activeClass . '" id="' . $categoryId . '-tab" data-bs-toggle="tab" href="#' . $categoryId . '" role="tab" aria-controls="' . $categoryAlias . '" aria-selected="true">' . $categoryAlias . '</a>';
              echo '</li>';
            }
          } else {
    ...
    <div class="card-content-wrapper bg-gray pt-50px pb-120px">
      <div class="container">
        <div class="tab-content" id="myTabContent">
          <?php
          # Reset the result pointer and the active state
          $result->data_seek(0);
          $isActive = true;
          if ($result->num_rows > 0) {
            while ($category = $result->fetch_assoc()) {
