        ...
        <div class="container">
          <div class="hero-content">
            ...
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1">
              <a href="admission.html" class="btn theme-btn me-4 mb-4">Join with Us <i class="la la-arrow-right icon ms-1"></i></a>
        ...
        <div class="container">
          <div class="hero-content text-center">
            ...
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-center">
              <a href="admission.html" class="btn theme-btn me-4 mb-4">Get Started <i class="la la-arrow-right icon ms-1"></i></a>
              <a href="#" class="btn-text video-play-btn mb-4" data-fancybox data-src="https://www.youtube.com/watch?v=cRXm1p-CNyk">
                Watch Preview<i class="la la-play icon-btn ms-2"></i>
              </a>
            </div>
        ...
        <div class="container">
          <div class="hero-content text-end">
            ...
            <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-end">
              <a href="#" class="btn-text video-play-btn me-4 mb-4" data-fancybox data-src="https://www.youtube.com/watch?v=cRXm1p-CNyk">
                <i class="la la-play icon-btn me-2"></i>Watch Preview
              </a>
              <a href="admission.html" class="btn theme-btn mb-4"><i class="la la-arrow-left icon me-1"></i>Get Enrolled
              </a>
            </div>
            <!-- end hero-btn-box -->
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img1.jpg" alt="Category image" />
          ...
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img2.jpg" alt="Category image" />
              <div class="category-content">
                <div class="category-inner">
          ...
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img3.jpg" alt="Category image" />
              <div class="category-content">
                <div class="category-inner">
          ...
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img4.jpg" alt="Category image" />
              <div class="category-content">
                <div class="category-inner">
          ...
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img5.jpg" alt="Category image" />
              <div class="category-content">
                <div class="category-inner">
          ...
          <div class="col-lg-4 responsive-column-half">
            <div class="category-item">
              <img class="cat__img lazy" src="assets/images/img-loading.png" data-src="assets/images/img6.jpg" alt="Category image" />
              <div class="category-content">
                <div class="category-inner">
