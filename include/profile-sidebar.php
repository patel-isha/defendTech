<div
      ...
      <div class="logo-box px-4">
        <a href="index.php" class="logo"><img src="assets/images/logo.png" class="w-70" alt="logo" /></a>
      </div>
      <ul
        class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        <li class="page-active">
          <a href="my-profile.php"><svg
              class="me-2"
        ...
        <li>
          <a href="progress-report.php"><svg
              class="me-2"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a
            ...
            data-bs-target="#deleteModal"><svg
              class="me-2"
              xmlns="http://www.w3.org/2000/svg"
              height="18px"
              viewBox="0 0 24 24"
