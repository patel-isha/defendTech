                                ...
                                <div class="components-preview wide-lg mx-auto">
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">List of Owners</h3>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                ...
                                                                <a href="add-owner.php" class="btn btn-lg btn-primary">Add Owner</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="nk-block nk-block-lg mt-3">
                                        <div class="card card-bordered card-preview">
                                            ...
                                            $sql = "SELECT * FROM `owners` WHERE email LIKE '%$search%'";
                                                                            ...
                                                                            <div class="drodown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                                    <ul class="link-list-opt no-bdr">
                                                                                        <li><a href="edit-owner.php?id=<?php echo $row['owner_id']?>" target="_blank">Edit</a></li>
                                                                                        <li><a onclick="deleteData('<?php echo $row['owner_id']; ?>')">Remove</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </li>
